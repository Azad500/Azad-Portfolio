      ...
      <ul className={styles.rightSide}>
        ...
        <li>
          <div className={styles.aboutWork}>
            ...
            <p>ALAS ACADEMY</p>
            <p>
              After completing the 6-month Front-end training I started in March
              2023, I started working remotely as a Front-end developer at Alas
              Development Center. I am currently working on several projects and
              learning new programming skills at the same time.
            </p>
            <span>Baku, Azerbaijan</span>
        ...
        <li>
          <div className={styles.aboutWork}>
            ...
            <p>
              ...
              production by going to the city of Lachin carrying out inspections
              in the fields. I completed my career in accounting in November
              because I wanted to change my field.
            </p>
        ...
        <li>
          <div className={styles.aboutWork}>
            ...
            <p>ARRIVER LLC</p>
            <p>
              Customs of products imported to Azerbaijan through the Bank making
              payments, making reports of all payments, external making payments
              to 1C software of imported products monthly for uploading and
              reporting to the tax authority preparation of reports, products
              through e-invoice to customers selling, attracting customers to
              the company, making bank payments conducting and controlling it,
              paying employees' salaries, Implementation of tax operations,
              problems occurring during work action on the execution of
              operations, etc... In addition, the skills: Accounting policies
              and controls, financial statements, Settlements, Processing of
              documents, Financial Information Systems, Audit of taxpayers'
              accounts, Account Reconciliation Processes, Payables and
              receivables, Calculation of liabilities, Fixed costs, Effective
              and Professional Communication, Nonconformity Assessment, Critical
              thinking and analysis, Tax obligations, Accounting of documents,
              Cash analysis
            </p>
            <span>Baku, Azerbaijan</span>
        ...
        <li>
          <div className={styles.aboutWork}>
            ...
            <p>Old Baku Cafe</p>
            <p>
              During my university years, I rented a cafe for a short period of
              time in order to spend my summer holidays both efficiently and to
              gain experience in business life. I ran a cafe for 3 months.
            </p>
            <span>Baku, Azerbaijan</span>
